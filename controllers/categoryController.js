...
const createCategory = async (req, res) => {
  ...
  const category = await categoryService.findNotDeletedCategory(
    locationId,
    name
  );
...
const updateCategory = async (req, res) => {
  ...
  try {
    const category = await categoryService.updateCategoryName(
      locationId,
      categoryId,
      name
    );
...
const deleteCategory = async (req, res) => {
  ...
  try {
    await categoryService.removeWorkManualIfCategoryDeleted(
      locationId,
      categoryId
    );
